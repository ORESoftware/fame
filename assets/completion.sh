...
function _mycli_completer {
    ...
    local cmd_shortopts="-b -h -v"
local cmd_longopts="--author --branch --completion --ends-with --endswith --ext --extension --extensions --help --json --match --not-match --sha --table --verbose --version"
local cmd_optargs="--author=arrayOfString --branch=string --ends-with=arrayOfString --endswith=arrayOfString --ext=arrayOfString --extension=arrayOfString --extensions=arrayOfString --match=arrayOfString --not-match=arrayOfString --sha=string -b=string"
